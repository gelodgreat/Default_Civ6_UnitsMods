...
VALUES	('UNIT_MOTORISED_INFANTRY',	'UNITAI_COMBAT'),
		...
		('UNIT_PIKE_AND_SHOT',		'UNITAI_COMBAT'),
		('UNIT_PIKE_AND_SHOT',		'UNITAI_EXPLORE'),
		('UNIT_PIKE_AND_SHOT',		'UNITTYPE_MELEE'),
		('UNIT_PIKE_AND_SHOT',		'UNITTYPE_LAND_COMBAT'),
		...
		('UNIT_ARMORED_CAR',		'UNITAI_EXPLORE'),
		('UNIT_ARMORED_CAR',		'UNITTYPE_CAVALRY'),
		('UNIT_ARMORED_CAR',		'UNITTYPE_MELEE'),
...
VALUES	('UNIT_MOTORISED_INFANTRY',	'CLASS_MELEE'),
		...
		('UNIT_PIKE_AND_SHOT',		'CLASS_ANTI_CAVALRY'),
		('UNIT_TANK_DESTROYER',		'CLASS_ANTI_CAVALRY'),
		('UNIT_LANCER',				'CLASS_LIGHT_CAVALRY'),
		('UNIT_ARMORED_CAR',		'CLASS_LIGHT_CAVALRY'),
		...
		('UNIT_UAV',				'CLASS_RECON'),
		('UNIT_UAV',				'CLASS_HELICOPTER'),
...
VALUES	('UNIT_MOTORISED_INFANTRY',	4,			540,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_MOTORISED_INFANTRY_NAME',	'LOC_UNIT_MOTORISED_INFANTRY_DESCRIPTION',	'YIELD_GOLD',	null,								'PROMOTION_CLASS_MELEE',			7,				78,		0,				0,		0,			null,					'TECH_COMBINED_ARMS',			null,						'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
		...
		('UNIT_PIKE_AND_SHOT',		2,			250,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_PIKE_AND_SHOT_NAME',		'LOC_UNIT_PIKE_AND_SHOT_DESCRIPTION',		'YIELD_GOLD',	null,								'PROMOTION_CLASS_ANTI_CAVALRY',		4,				50,		0,				0,		0,			null,					'TECH_MASS_PRODUCTION',			'TECH_SCIENTIFIC_THEORY',	'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
		...
		('UNIT_ARMORED_CAR',		5,			390,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_ARMORED_CAR_NAME',		'LOC_UNIT_ARMORED_CAR_DESCRIPTION',			'YIELD_GOLD',	null,								'PROMOTION_CLASS_LIGHT_CAVALRY',	6,				68,		0,				0,		0,			'RESOURCE_OIL',			'TECH_COMBUSTION',				'TECH_COMPOSITES',			'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
		('UNIT_ARMORED_CAVALRY',	5,			450,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_ARMORED_CAVALRY_NAME',	'LOC_UNIT_ARMORED_CAVALRY_DESCRIPTION',		'YIELD_GOLD',	null,								'PROMOTION_CLASS_LIGHT_CAVALRY',	6,				75,		0,				0,		0,			'RESOURCE_OIL',			'TECH_PLASTICS',				null,						'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
		...
		('UNIT_UAV',				4,			700,	'ADVISOR_CONQUEST',	5,				'1',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_UAV_NAME',				'LOC_UNIT_UAV_DESCRIPTION',					'YIELD_GOLD',	null,								'PROMOTION_CLASS_RECON',			7,				70,		80,				1,		0,			'RESOURCE_ALUMINUM',	'TECH_NANOTECHNOLOGY',			null,						'1',			0,				0,			'0',			'0',		null,					'1',		'0'),
		('UNIT_CORVETTE',			4,			260,	'ADVISOR_CONQUEST',	3,				'1',			'DOMAIN_SEA',	'FORMATION_CLASS_NAVAL',		'LOC_UNIT_CORVETTE_NAME',			'LOC_UNIT_CORVETTE_DESCRIPTION',			'YIELD_GOLD',	'PSEUDOYIELD_UNIT_NAVAL_COMBAT',	'PROMOTION_CLASS_NAVAL_MELEE',		4,				50,		0,				0,		0,			null,					'TECH_CARTOGRAPHY',				'TECH_STEAM_POWER',			'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
		...
		('UNIT_GALLEASS',			4,			240,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_SEA',	'FORMATION_CLASS_NAVAL',		'LOC_UNIT_GALLEASS_NAME',			'LOC_UNIT_GALLEASS_DESCRIPTION',			'YIELD_GOLD',	'PSEUDOYIELD_UNIT_NAVAL_COMBAT',	'PROMOTION_CLASS_NAVAL_RANGED',		3,				35,		45,				2,		0,			null,					'TECH_EDUCATION',				'TECH_SQUARE_RIGGING',		'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
		...
		('UNIT_GALLEON',			3,			280,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_SEA',	'FORMATION_CLASS_NAVAL',		'LOC_UNIT_GALLEON_NAME',			'LOC_UNIT_GALLEON_DESCRIPTION',				'YIELD_GOLD',	'PSEUDOYIELD_UNIT_NAVAL_COMBAT',	'PROMOTION_CLASS_NAVAL_RANGED',		4,				40,		0,				3,		50,			null,					'TECH_EDUCATION',				'TECH_SQUARE_RIGGING',		'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
		('UNIT_SHIP_OF_THE_LINE',	3,			320,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_SEA',	'FORMATION_CLASS_NAVAL',		'LOC_UNIT_SHIP_OF_THE_LINE_NAME',	'LOC_UNIT_SHIP_OF_THE_LINE_DESCRIPTION',	'YIELD_GOLD',	'PSEUDOYIELD_UNIT_NAVAL_COMBAT',	'PROMOTION_CLASS_NAVAL_RANGED',		4,				50,		0,				3,		60,			null,					'TECH_SQUARE_RIGGING',			'TECH_STEAM_POWER',			'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
		('UNIT_PRE_DREADNOUGHT',	4,			440,	'ADVISOR_CONQUEST',	2,				'1',			'DOMAIN_SEA',	'FORMATION_CLASS_NAVAL',		'LOC_UNIT_PRE_DREADNOUGHT_NAME',	'LOC_UNIT_PRE_DREADNOUGHT_DESCRIPTION',		'YIELD_GOLD',	'PSEUDOYIELD_UNIT_NAVAL_COMBAT',	'PROMOTION_CLASS_NAVAL_RANGED',		5,				60,		0,				3,		70,			'RESOURCE_COAL',		'TECH_STEAM_POWER',				'TECH_STEEL',				'0',			0,				0,			'0',			'0',		null,					'1',		'0');
...
VALUES	('UNIT_MOTORISED_INFANTRY',	'UNIT_MECHANIZED_INFANTRY'),
		...
		('UNIT_PIKE_AND_SHOT',		'UNIT_GATLING_GUN'),
		('UNIT_TANK_DESTROYER',		'UNIT_MODERN_AT'),
		('UNIT_LANCER',				'UNIT_CAVALRY'),
		('UNIT_ARMORED_CAR',		'UNIT_ARMORED_CAVALRY'),
		('UNIT_ARMORED_CAVALRY',	'UNIT_HELICOPTER'),
		('UNIT_MACHINE_GUN',		'UNIT_SNIPER'),
...
VALUES	('UNIT_TERCIO',					'UNIT_PIKE_AND_SHOT'),
